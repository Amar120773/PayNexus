...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'default', size = 'default', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      primary: 'bg-primary text-primary-foreground hover:bg-primary/90', // fallback
      danger: 'bg-destructive text-destructive-foreground hover:bg-destructive/90', // fallback
    };
